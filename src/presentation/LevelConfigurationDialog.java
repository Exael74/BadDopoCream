...
public class LevelConfigurationDialog extends JDialog {
    ...
    public LevelConfigurationDialog(Frame owner, GameFacade gameFacade) {
        ...
        fogataSpinner = new JSpinner(new SpinnerNumberModel(gameFacade.getFogataCountConfig(), 0, 20, 1));
        styleSpinner(fogataSpinner);
        JLabel labelFog = new JLabel("Fogatas:");
        labelFog.setFont(FontLoader.getInstance().getPlainFont(16f));
        obstaclePanel.add(labelFog);
        obstaclePanel.add(fogataSpinner);
    ...
    private void updateConfiguration() {
        ...
        // Update Fogatas
        gameFacade.setFogataCountConfig((Integer) fogataSpinner.getValue());
    }
